...
class NistReader(object):
    ...
    def __init__(self, sample_rate = 16000, sample_n_bytes = 2, n_channels = 1, nist_extention = ".WAV"):
        ...
        Inputs:
        - sample_rate: Sample rate in Hz. A number of samples in one second.
        - sample_n_bytes: A number of bytes per each sample.
        - n_channels: Number of channels 1 = mono, 2 = stereo.
        - nist_extention: A Nist file extention.
        """
    ...
    def Nist2Wav(self, input_file, output_folder):
        ...
        Inputs:
        - input_file: a path to a nist file
        - output_folder: a path to output folder where the converted file will be saved. 
        ...
        # the converted file will be saved with the same name but with the different extention.
