...
tf.app.flags.DEFINE_string('eval_dir', '/tmp/eva_eval',
...
def evaluate():
  ...
  with tf.Graph().as_default() as g, TFStorage(config.TEST_DATESET_FILE_PATH(), TFStorageOpenOptions.READ) as storage:
    ...
    soundFeatures, labels = storage.read_once(TFStorageLabelOption.PHONEME, config.NUM_EXAMPLES_PER_EPOCH_FOR_EVAL)
